...
#define CONFIG_ESPSUPP_INTERNAL_MEM_ALLOC 1
#define CONFIG_ESPSUPP_ASYMMETRIC_CONTENT_LEN 1
#define CONFIG_ESPSUPP_SSL_IN_CONTENT_LEN 16384
#define CONFIG_ESPSUPP_SSL_OUT_CONTENT_LEN 4096
#define CONFIG_ESPSUPP_HAVE_TIME 1
#define CONFIG_ESPSUPP_ECDSA_DETERMINISTIC 1
#define CONFIG_ESPSUPP_SHA512_C 1
#define CONFIG_ESPSUPP_TLS_SERVER_AND_CLIENT 1
#define CONFIG_ESPSUPP_TLS_SERVER 1
#define CONFIG_ESPSUPP_TLS_CLIENT 1
#define CONFIG_ESPSUPP_TLS_ENABLED 1
#define CONFIG_ESPSUPP_KEY_EXCHANGE_RSA 1
#define CONFIG_ESPSUPP_KEY_EXCHANGE_DHE_RSA 1
#define CONFIG_ESPSUPP_KEY_EXCHANGE_ELLIPTIC_CURVE 1
#define CONFIG_ESPSUPP_KEY_EXCHANGE_ECDHE_RSA 1
#define CONFIG_ESPSUPP_KEY_EXCHANGE_ECDHE_ECDSA 1
#define CONFIG_ESPSUPP_KEY_EXCHANGE_ECDH_ECDSA 1
#define CONFIG_ESPSUPP_KEY_EXCHANGE_ECDH_RSA 1
#define CONFIG_ESPSUPP_SSL_RENEGOTIATION 1
#define CONFIG_ESPSUPP_SSL_PROTO_TLS1 1
#define CONFIG_ESPSUPP_SSL_PROTO_TLS1_1 1
#define CONFIG_ESPSUPP_SSL_PROTO_TLS1_2 1
#define CONFIG_ESPSUPP_SSL_ALPN 1
#define CONFIG_ESPSUPP_CLIENT_SSL_SESSION_TICKETS 1
#define CONFIG_ESPSUPP_SERVER_SSL_SESSION_TICKETS 1
#define CONFIG_ESPSUPP_AES_C 1
#define CONFIG_ESPSUPP_RC4_DISABLED 1
#define CONFIG_ESPSUPP_CCM_C 1
#define CONFIG_ESPSUPP_GCM_C 1
#define CONFIG_ESPSUPP_PEM_PARSE_C 1
#define CONFIG_ESPSUPP_PEM_WRITE_C 1
#define CONFIG_ESPSUPP_X509_CRL_PARSE_C 1
#define CONFIG_ESPSUPP_X509_CSR_PARSE_C 1
#define CONFIG_ESPSUPP_ECP_C 1
#define CONFIG_ESPSUPP_ECDH_C 1
#define CONFIG_ESPSUPP_ECDSA_C 1
#define CONFIG_ESPSUPP_ECP_DP_SECP192R1_ENABLED 1
#define CONFIG_ESPSUPP_ECP_DP_SECP224R1_ENABLED 1
#define CONFIG_ESPSUPP_ECP_DP_SECP256R1_ENABLED 1
#define CONFIG_ESPSUPP_ECP_DP_SECP384R1_ENABLED 1
#define CONFIG_ESPSUPP_ECP_DP_SECP521R1_ENABLED 1
#define CONFIG_ESPSUPP_ECP_DP_SECP192K1_ENABLED 1
#define CONFIG_ESPSUPP_ECP_DP_SECP224K1_ENABLED 1
#define CONFIG_ESPSUPP_ECP_DP_SECP256K1_ENABLED 1
#define CONFIG_ESPSUPP_ECP_DP_BP256R1_ENABLED 1
#define CONFIG_ESPSUPP_ECP_DP_BP384R1_ENABLED 1
#define CONFIG_ESPSUPP_ECP_DP_BP512R1_ENABLED 1
#define CONFIG_ESPSUPP_ECP_DP_CURVE25519_ENABLED 1
#define CONFIG_ESPSUPP_ECP_NIST_OPTIM 1
#define CONFIG_WPA_ESPSUPP_CRYPTO 1
