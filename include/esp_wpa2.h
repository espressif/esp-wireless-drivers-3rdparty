...
/**
  ...
  * @attention  2. Disabling the WPA_ESPSUPP_CRYPTO config is required to use EAP-FAST.
  *
...
/**
  ...
  *
  * @attention  1. Disabling the WPA_ESPSUPP_CRYPTO config is required to use EAP-FAST.
  *
