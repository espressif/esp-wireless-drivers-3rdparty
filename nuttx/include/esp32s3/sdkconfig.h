...
#define CONFIG_SOCSOC_SHA_SUP_MCPWM_COMPARATORS_PER_OPERATOR 2
...
#define CONFIG_ESP_PHY_REDUCE_TX_POWER 0
...
#define CONFIG_ESP32_PHY_MULTIPLE_INIT_DATA_BIN 0
...
#define CONFIG_ESP_TIMER_SUPPORTS_ISR_DISPATCH_METHOD 0
#define CONFIG_WPA_SCAN_CACHE 0
#define CONFIG_ESP_WIFI_GMAC_SUPPORT 0
#define CONFIG_PM_ENABLE 0
#define CONFIG_ESP_SYSTEM_CHECK_INT_LEVEL_5 0

#ifdef CONFIG_ESP_WPA_DEBUG_PRINT
